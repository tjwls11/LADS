...
def settings_page():
    ...
    if request.method == "POST":
        updates = {
            ...
            "LOGIN_ID_1":             request.form.get("login_id_1", ""),
            "LOGIN_PASSWORD_1":       request.form.get("login_password_1", ""),
            "LOGIN_ID_2":           request.form.get("login_id_2", ""),
            "LOGIN_PASSWORD_2":     request.form.get("login_password_2", ""),
